...
const seo = {
  title: "New Patient Vet Appointment in Northern Kentucky | Veterinary Medical Centers",
  description:
    "New to Veterinary Medical Centers? Request your first vet appointment at our Fort Thomas or Independence, KY locations for dogs and cats."
};
...
const faqs = [
  {
    question: "How do I become a new patient at Veterinary Medical Centers?",
    answer:
  ...
  },
  {
    ...
    answer: "Yes. Choose the Veterinary Medical Centers location that works best for you, or select no preference and our team can help."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. Veterinary Medical Centers welcome new dog and cat patients at both Northern Kentucky locations."
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Veterinary Medical Centers is locally and independently owned. Care decisions are made close to the pets, families, and Northern Kentucky communities we serve."
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Veterinary Medical Centers help puppies and kittens get started with exams, vaccines, parasite prevention, nutrition guidance, behavior questions, and planning for long-term care."
  }
];
  ...
  return (
    <>
        ...
        <div className="np-independent-panel">
          <figure className="np-editorial-image">
            <Image
              ...
              alt="Veterinary team caring for a cat at Veterinary Medical Centers in Northern Kentucky"
              width={900}
              height={600}
          ...
          <div>
            ...
            <p>
              Veterinary Medical Centers is locally and independently owned, which means our care is guided by the pets and families in front of us,
            ...
            <Button href="/about/" variant="ghost">Learn more about Veterinary Medical Centers</Button>
          </div>
        </div>
      </Section>
      ...
      <Section
        ...
        intro="Veterinary Medical Centers welcome new clients from Fort Thomas, Independence, Highland Heights, Newport, Bellevue, Dayton, Alexandria, and surrounding Northern Kentucky communities."
      >
        <div className="np-seo-panel">
          <div>
            <h3>Two local clinics for dogs, cats, and the people who love them.</h3>
            <p>
              Veterinary Medical Centers welcome new clients from Fort Thomas, Independence, Newport, Bellevue, Dayton, Highland Heights,
          ...
          <figure className="np-editorial-image np-seo-image">
            <Image
              ...
              alt="Locally owned Veterinary Medical Centers clinic serving dogs and cats in Northern Kentucky"
              width={900}
              height={454}
          ...
          <nav aria-label="Helpful new patient links">
            ...
            <Link href="/about/">Meet Veterinary Medical Centers</Link>
      ...
      <Section
        ...
        intro="Both Veterinary Medical Centers locations provide the same relationship-based care for dogs and cats. Choose the clinic that is most convenient for your family."
      >
        <div className="np-location-grid">
          {settings.publicLocations.map((location) => (
            <article key={location.id}>
              <MapEmbed src={location.mapEmbedUrl} title={`Map to Veterinary Medical Centers ${location.name}`} />
      ...
      <FAQSection faqs={faqs} title="Common new patient questions" />
