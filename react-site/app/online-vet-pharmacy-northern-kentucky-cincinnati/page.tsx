  ...
  return (
    <>
      <Hero
        ...
        primaryCta={{ label: "Open Online Pharmacy", href: site.pharmacyExternalUrl }}
      ...
      <Section tone="white" eyebrow="Medication Support" title="Online convenience with local veterinary coordination.">
        <div className="card-grid compact">
          <article className="card">
            ...
            <a href={site.pharmacyExternalUrl} target="_blank" rel="noopener noreferrer">Visit pharmacy</a>
          </article>
          <article className="card">
