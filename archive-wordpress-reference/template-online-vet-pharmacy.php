...
$ext_url  = get_field( 'pharmacy_external_link_url' ) ?: vmc_get( 'vmc_pharmacy_url', 'https://nky-vet.ourvet.com/' );
$h1       = get_field( 'pharmacy_h1' )    ?: get_the_title();
$intro    = get_field( 'pharmacy_intro' ) ?: 'Order medications, request refills, and access vet-approved products — delivered to your door with local team support.';
?>
...
<div class="tool-page">
  ...
  <section class="tool-hero">
    <div class="rv">
      <div class="eyebrow"><span class="eyebrow-dash"></span><?php esc_html_e( 'Online Pharmacy', 'vmc' ); ?></div>
      ...
      <div class="tool-hero-btns">
        <a class="btn-red" href="<?php echo esc_url( $ext_url ); ?>" target="_blank" rel="noopener noreferrer">
          <?php esc_html_e( 'Visit Online Pharmacy', 'vmc' ); ?>
        </a>
        <a class="btn-ghost" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">
          <?php esc_html_e( 'Contact the Clinic', 'vmc' ); ?>
        </a>
      </div>
    </div>
  </section>
